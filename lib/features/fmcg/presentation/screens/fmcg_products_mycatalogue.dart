...
class ProductsListMyCatalogueParams {
...
class FmcgProductsMycatalogue extends StatefulWidget {
  final ProductsListMyCatalogueParams params;
  const FmcgProductsMycatalogue({super.key, required this.params});

  @override
  State<FmcgProductsMycatalogue> createState() => _FmcgProductsMycatalogueState();
}

class _FmcgProductsMycatalogueState extends State<FmcgProductsMycatalogue>
  ...
  void getProductsList({String search = ""}) async {
    ...
    await chatCubit.getProductsListForSeller(params);
  }
    ...
    return AdaptiveScaffold(
      body: BlocListener<ChatCubit, ChatState>(
        ...
        listener: (context, state) async {
          if (state is ProductsListForSellerSuccess) {
        ...
        child: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              BlocBuilder<ChatCubit, ChatState>(
                builder: (context, state) {
                  if (state is ProductsListForSellerIsLoading ||
