...
class BuyerPostRequirementScreen extends StatefulWidget {
  ...
  @override
  State<BuyerPostRequirementScreen> createState() =>
    ...
    return MultiBlocListener(
      ...
      child: GestureDetector(
        ...
        child: AdaptiveScaffold(
          ...
          //     title: 'Post your Requirement', centerTitle: true, actions: []),
            ...
            buildWhen: (previous, current) {
              ...
              result = result &&
                  (current is GetDashboardSuccess ||
                      ...
                      current is AddCustomerRequirementSuccess ||
                      current is AddCustomerRequirementError ||
                      current is AddCustomerRequirementIsLoading);
              return result;
            },
                  ...
                  BlocBuilder<DashboardCubit, DashboardState>(
                    ...
                    builder: (context, state) {
                      if (state is GetAllListIsLoading ||
                          ...
                          state is AddCustomerRequirementIsLoading) {
                        return const CommonLoader();
                      }
